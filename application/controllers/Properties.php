...
class Properties extends CI_Controller {
    ...
    public function property_search() {
        ...
        if ($ps_bedrooms != '') {
            $search_query.=' and prop_list.bedroom_no>=' . $ps_bedrooms;
        }
        if ($ps_bathrooms != '') {
            $search_query.=' and prop_list.bathroom_no>=' . $ps_bathrooms;
        }
        if ($ps_loc != '') {
            $search_query.=' and prop_list.locality="' . $ps_loc . '"';
        }
        ...
        if ($order == '' || $order == 'latest') {
            $order_query = ' ORDER BY prop_list.created DESC';
            $this->data['order'] = 'latest';
        } else if ($order == 'price_asc') {
            $order_query = ' ORDER BY prop_list.price ASC';
        } else if ($order == 'price_desc') {
            $order_query = ' ORDER BY prop_list.price DESC';
        } else if ($order == 'bed_asc') {
            $order_query = ' ORDER BY prop_list.bedroom_no ASC';
        } else if ($order == 'bed_desc') {
            $order_query = ' ORDER BY prop_list.bedroom_no DESC';
        }
