...
<div class="content">
    ...
    <div class="panel panel-flat">
        <div class="panel-heading text-right">
            <a href="<?php echo site_url('admin/newsletters/add'); ?>" class="btn btn-success btn-labeled"><b><i class="icon-plus-circle2"></i></b> Add newsletter</a>
        </div>
             ...
             foreach ($newsletters as $newsletter) { ?>
                <tr>
                   ...
                   <?php /* <td><?php 
                        ...
                        <td>
                            <?php if ($newsletter['setting_id'] != null && $newsletter['content'] != '') { ?>
