                        ...
                        */ ?>
                        <fieldset>
                            ...
                            <div class="form-group">
                                ...
                                <div class="col-lg-10">
                                    <input type="text" id="email_tags" value="<?php if(isset($testing_emails[0]['email_ids'])) echo $testing_emails[0]['email_ids']; ?>" class="tags-input form-control" name="testing_emails">
                                </div>
                            </div>
                        </fieldset>
                        <fieldset>
