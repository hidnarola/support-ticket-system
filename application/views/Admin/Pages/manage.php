                    ...
                    <div class="panel panel-flat">
                        <div class="panel-body">
                            ...
                            <div class="form-group">
                                ...
                                <input type="text" required="required" name="meta_title" id="meta_title" class="form-control" value="<?php echo isset($page_data['meta_title']) ? $page_data['meta_title'] : set_value('meta_title'); ?>">
                                <?php echo '<label id="meta_title-error" class="validation-error-label" for="meta_title">' . form_error('meta_title') . '</label>'; ?>
                            </div>
                            <div class="form-group">
                                <label>SEO Meta keyword:</label>
                                <input type="text" required="required" name="meta_keyword" id="meta_keyword" class="form-control" value="<?php echo isset($page_data['meta_keyword']) ? $page_data['meta_keyword'] : set_value('meta_keyword'); ?>">
                                <?php echo '<label id="meta_keyword-error" class="validation-error-label" for="meta_keyword">' . form_error('meta_keyword') . '</label>'; ?>
                            </div>
                            <div class="form-group">
                                <label>SEO Meta Description:</label>
                                <input type="text" required="required" name="meta_description" id="meta_description" class="form-control" value="<?php echo isset($page_data['meta_description']) ? $page_data['meta_description'] : set_value('meta_description'); ?>">
                                <?php echo '<label id="meta_description-error" class="validation-error-label" for="meta_description">' . form_error('meta_description') . '</label>'; ?>
                            </div>
