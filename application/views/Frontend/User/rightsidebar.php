...
<div class="col-sm-3 clearfix">
    ...
    <div class="list-group">
        ...
        <a  href="profile/chanagepassword" class="list-group-item clearfix <?php echo ($page_sec == 'chanagePassword') ? 'active' : ''; ?>">Change Password <i class="icon-edit pull-right"></i></a>
