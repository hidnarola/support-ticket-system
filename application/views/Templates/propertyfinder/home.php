...
<html lang="en-US" class="scheme_original">
    ...
    <body class="<?php echo $class ?>">
        <div class="body_wrap">
            <div class="page_wrap">
                <header class="top_panel_wrap top_panel_style_1 scheme_original">
                    <div class="header-bg">
                        <div class="top_panel_wrap_inner top_panel_inner_style_1 top_panel_position_over <?php if ($this->uri->segment(1) == '' || $this->uri->segment(1) == 'home2' || ($this->uri->segment(1) == 'property-listing' && $this->uri->segment(2) == '')) {
        echo 'header_shadow';
    } else {
        echo 'header_shadow2';
    } ?>">
        ...
        echo 'current-menu-parent';
                                            ...
                                            <li class="menu-item <?php if ($page == '') {
                                                echo 'current-menu-parent';
                                            } ?>">
        ...
        if (isset($value['sub_menus'])) {
            foreach ($value['sub_menus'] as $key1 => $value1) {
                ?>
                                                        ...
                                                        ?>
                                                        <li class="mega-menu <?php if ($page == $value['url']) {
                                                echo 'current-menu-parent';
                                            } ?>">
                                                            <a href="<?php echo site_url($value['url']); ?>" target="<?php if (in_array($value['url'], $header_array)) {
                                                echo '_blank';
                                            } ?>">
...
?>
                                            <li class="menu-menu <?php if ($page == 'portfolio') {
    echo 'current-menu-parent';
} ?>">
                                                <a href="portfolio">Portfolio</a>
                                            </li>

<!--                                 <li class="menu-menu <?php if ($page == 'gallery') {
    echo 'current-menu-parent';
} ?>">
   <a href="gallery">Gallery</a>
                         ...
                         <!-- <li class="menu-item <?php if ($current_page == 'pages' && $page_url == 'about-us') {
    echo 'current-menu-parent';
} ?>"><a href="property-finder/pages/about-us">About Us</a></li>
                         <li class="menu-item"><a href="#">Service</a></li>
                         <li class="menu-item"><a href="#">Media</a></li>
                         <li class="menu-item"><a href="#">Contact Us</a></li> -->
                                            <li class="menu-item login_dropdown <?php if (!empty($this->session->userdata('user_logged_in'))) {
